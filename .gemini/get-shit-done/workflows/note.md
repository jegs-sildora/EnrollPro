...
- **Global scope**: `C:/Users/Admin/Documents/EnrollPro/enrollpro/.gemini/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/Admin/Documents/EnrollPro/enrollpro/.gemini/notes/`)
...
2. Glob `C:/Users/Admin/Documents/EnrollPro/enrollpro/.gemini/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/Admin/Documents/EnrollPro/enrollpro/.gemini/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/Admin/Documents/EnrollPro/enrollpro/.gemini/notes/` — works in any directory
