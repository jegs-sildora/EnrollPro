...
import { CheckCircle2, Copy, Check, UserPlus, FileText, ClipboardList, ArrowRight } from 'lucide-react';
      ...
      <Card className="shadow-lg border-2 border-primary/20">
        <CardHeader className="text-center pb-2">
          ...
          <CardDescription className="text-lg">
            Walk-in admission has been successfully recorded.
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-6 pt-6">
          ...
          <div className="bg-muted/50 p-4 rounded-xl border border-border/50">
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div>
                <p className="text-[10px] text-muted-foreground uppercase tracking-wide font-bold mb-1">Encoded By</p>
                <p className="font-semibold">{encodedBy}</p>
              </div>
              <div>
                <p className="text-[10px] text-muted-foreground uppercase tracking-wide font-bold mb-1">Date & Time</p>
                <p className="font-semibold">{format(new Date(), "MMM dd, yyyy 'at' h:mm a")}</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm list-decimal pl-5">
              <li>
                <strong>Provide tracking number:</strong> Give the applicant their tracking number for monitoring.
              </li>
              <li>
                <strong>Document submission:</strong> Collect and verify original documents (PSA Birth Certificate, SF9).
              </li>
              <li>
                <strong>Application review:</strong> The application is now in the queue for registrar review.
              </li>
              <li>
                <strong>SCP applicants:</strong> Schedule entrance exam/audition if applicable.
              </li>
            </ul>
          </div>
