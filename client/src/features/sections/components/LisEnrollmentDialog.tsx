      ...
      <DialogContent className="w-full max-w-3xl p-0 overflow-hidden border-none shadow-2xl backdrop-blur-md bg-white/95 rounded-2xl">
        ...
        <DialogHeader className="px-6 pt-5 pb-4 border-b border-slate-100 flex flex-row items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <DialogTitle className="text-lg font-extrabold uppercase text-slate-800 tracking-wide">
                LIS Learner Enrollment
              </DialogTitle>
              <p className="text-base font-extrabold text-slate-500 uppercase mt-0.5">
            ...
            <div className="max-h-[350px] min-h-[250px] overflow-y-auto px-6 py-4">
              {loading && prospectiveList.length === 0 ? (
                ...
                <div className="py-16 flex flex-col items-center justify-center text-center">
                  ...
                  <p className="text-base leading-tight font-extrabold text-slate-700">No prospective enrolees found</p>
                    ...
                    <tbody className="divide-y divide-slate-100  text-slate-700">
                      {prospectiveList.map((app) => (
                        ...
                        >
                          ...
                          <td className="py-2 px-3 text-center text-base font-extrabold">
                            {app.sex === "MALE" ? "M" : "F"}
                          </td>
              ...
              <div className="flex gap-2">
                <div className="relative flex-1">
                  ...
                  <Input
                    ...
                    className="pl-10 h-10 font-extrabold border-slate-200 shadow-sm focus-visible:ring-emerald-500/20"
                    onKeyDown={(e) => {
                ...
                <Button
                  ...
                  className="bg-emerald-600 hover:bg-emerald-700 text-white font-extrabold h-10 uppercase text-base"
                >
                  Search
                </Button>
              </div>
              ...
              {loading ? (
                ...
                <div className="p-4 rounded-xl border-2 border-emerald-100 bg-emerald-50/20 space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      ...
                      className="text-base font-extrabold uppercase text-slate-500 hover:text-slate-800"
                    >
                      Clear Selection
                    </Button>
                  </div>
                ...
                searchQuery.trim() ? (
                  <div className="py-12 flex flex-col items-center justify-center text-center">
                    ...
                    <p className="text-base leading-tight font-extrabold text-slate-700">No unsectioned matches found</p>
                  ...
                  <div className="py-12 flex flex-col items-center justify-center text-center text-slate-400">
                    ...
                    <p className="text-base font-extrabold">Enter LRN or student last name to search LIS</p>
                  </div>
                )
              ) : (
        ...
        <DialogFooter className="px-6 py-4 border-t border-slate-100 flex items-center justify-between sm:justify-between bg-slate-50/50 shrink-0">
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              className="font-extrabold uppercase text-base border-slate-200"
            >
              Cancel
            </Button>
            {activeTab === "prospective" ? (
