...
interface UserAccountFormSheetProps {
  ...
  onResetToDefault?: (password: string) => Promise<void>;
}
...
export const UserAccountFormSheet = memo(function UserAccountFormSheet({
  ...
  const [customPassword, setCustomPassword] = useState(defaultPassword || "DepEd2026!");
        ...
        <div className="flex-1 flex flex-col h-full overflow-hidden bg-background">
          ...
          <div className="bg-primary px-6 py-5 relative shrink-0 border-b border-border shadow-sm flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="space-y-0.5">
                <h2 className=" font-extrabold text-primary-foreground uppercase leading-none">
                  {displayName}
                </h2>
                {user?.roles?.includes("LEARNER") ? (
                  <p className=" leading-tight font-extrabold text-primary-foreground uppercase tracking-wide flex items-center gap-1.5 mt-1.5">
            ...
            {mode === "edit" && user && (
              <div className="flex items-center gap-3 shrink-0 pr-8">
                <Badge
                  className={cn(
                    " leading-tight font-extrabold uppercase transition-all shadow-sm border",
                    user.isActive
            ...
            <div className="space-y-4">
              ...
              {!(mode === "edit" && user?.roles.includes("LEARNER")) && (
                <div className="bg-card border border-border rounded-xl overflow-hidden shadow-sm mb-4">
                  <div className="px-5 py-4 font-extrabold uppercase  leading-tight tracking-wide text-foreground bg-muted/5 border-b border-border flex justify-between items-center">
                  ...
                  <div className="px-5 pb-5 pt-4">
                    ...
                    <div className="space-y-2">
                      <Label className=" leading-tight font-extrabold uppercase text-foreground">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-2">
                        {([
                          ...
                          <div key={roleOption.value} className="flex items-center space-x-2 bg-background p-2 rounded border border-border">
                            ...
                            />
                            <Label htmlFor={`role-${roleOption.value}`} className=" font-extrabold uppercase cursor-pointer flex-1">
                              {roleOption.label}
                            </Label>
                          </div>
                        ))}
                        ...
                        <div className="flex gap-4">
                          {(
                            ...
                            <button
                              ...
                              className={cn(
                                "flex flex-1 items-center justify-center gap-2 rounded-lg border-2 px-4 py-2 transition-colors  leading-tight font-extrabold uppercase",
                                formData.sex === s.val
                    ...
                    <div className="bg-card border border-border rounded-xl overflow-hidden shadow-sm mb-4">
                      ...
                      <div className="px-5 pb-5 pt-4">
                        ...
                        <div className="grid gap-4 sm:grid-cols-2 mb-4">
                          {needsEmployeeId && (
                            <div className="space-y-1.5">
                              <Label className=" leading-tight font-extrabold uppercase text-foreground flex items-center gap-1">
                          ...
                          {needsDepartment && (
                            <div className="space-y-1.5">
                              ...
                              <Select
                                ...
                                <SelectTrigger className="font-extrabold  leading-tight bg-background text-foreground border-border h-10">
                                  <SelectValue />
                                </SelectTrigger>
                                <SelectContent className="bg-popover text-popover-foreground border-border font-extrabold  leading-tight uppercase">
                        ...
                        <div className="space-y-1.5">
                          ...
                          {formData.roles.includes("MRF") || designationPool.length === 0 ? (
                            ...
                            >
                              ...
                              <SelectContent className="bg-popover text-popover-foreground border-border font-extrabold  leading-tight uppercase max-h-[300px]">
                                <SelectItem value="__NONE__">Not set</SelectItem>
              ...
              {mode === "edit" && user && (
                <div className="bg-card border border-border rounded-xl overflow-hidden shadow-sm mb-4">
                  ...
                  <div className="px-5 pb-5 pt-4 space-y-6">
                    ...
                    <div className="space-y-3 p-4 bg-background border rounded-lg">
                      ...
                      <div className="flex gap-4">
                        <button
                          ...
                          className={cn(
                            "flex flex-1 items-center justify-center gap-2 rounded-lg border-2 px-4 py-2.5 transition-colors  leading-tight font-extrabold uppercase",
                            formData.isActive
                        ...
                        >
                          <div className={cn(
                            ...
                            formData.isActive ? "border-green-500" : "border-muted-foreground",
                          )}>
                            {formData.isActive && <div className="size-2 rounded-full bg-green-500" />}
                          </div>
                          Allow Access (Active)
                        </button>
                        <button
                        ...
                        >
                          <div className={cn(
                            "size-4 rounded-full border-2 flex items-center justify-center",
                            !formData.isActive ? "border-red-500" : "border-muted-foreground",
                          )}>
                            {!formData.isActive && <div className="size-2 rounded-full bg-red-500" />}
                          </div>
                          Suspend Access (Restricted)
                        </button>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3 p-4 bg-background border rounded-lg">
                      <div className="space-y-1.5">
                        <Label className=" font-extrabold uppercase text-foreground">Customize Default Password</Label>
                        <Input
                          type="text"
                          value={customPassword}
                          onChange={(e) => setCustomPassword(e.target.value)}
                          placeholder="DepEd2026!"
                          className="font-extrabold  leading-tight bg-background h-10"
                        />
                      </div>
                      <Button
                        type="button"
                        variant="secondary"
                        className="w-full font-extrabold uppercase  leading-tight h-10"
                    ...
                    <div className="space-y-1.5 mb-4">
                      ...
                      <div className="flex gap-2">
                        <Input
                          ...
                          readOnly
                          className="font-extrabold  leading-tight bg-muted/30 text-foreground border-border h-10"
                        />
                        <Button
                          variant="outline"
                          size="icon"
          ...
          <div className="border-t border-border px-6 py-4 flex flex-col-reverse gap-2 sm:flex-row sm:justify-end shrink-0 bg-muted/5">
            <Button
              ...
              className="w-full sm:w-auto font-extrabold uppercase px-8 shadow-lg shadow-primary/20">
              {submitting ? (
                <>
