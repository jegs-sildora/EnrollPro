...
import { Stepper } from '@/features/admission/pages/apply/stepper';
...
export default function F2FStepProgressBar({ currentStep, totalSteps, steps, description, completedUpTo }: F2FStepProgressBarProps) {
