...
<div className="space-y-6 max-w-6xl mx-auto">
      ...
      <div className="flex items-center justify-between bg-muted p-6 rounded-xl border shadow-sm">
          ...
          <div>
            <div className="flex items-center gap-3">
              ...
              {student.applicantType === "LATE_ENROLLEE" && (
                <Badge className="bg-amber-100 text-amber-700 hover:bg-amber-100 border-amber-200 uppercase font-extrabold">
                  🕒 Late Enrollee
                </Badge>
              )}
            </div>
            ...
            {student.status === "TEMPORARILY_ENROLLED" && (
              <div className="flex items-center gap-2 mt-1 px-3 py-1 rounded-lg bg-amber-50 border border-amber-100 animate-in fade-in slide-in-from-left-2 duration-500">
                ...
                <p className="text-base font-extrabold uppercase  text-amber-700">
                  Deficiency:{" "}
            ...
            <div className="flex items-center gap-4 mt-1 text-foreground text-base leading-tight font-extrabold">
        ...
        <div className="hidden md:block text-right">
          ...
          <p className="text-lg  font-extrabold">{student.trackingNumber}</p>
        </div>
      </div>
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-2 gap-4 text-base leading-tight">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="font-extrabold uppercase">{student.sex}</p>
                      </div>
                      <div className="space-y-1">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="font-extrabold">{student.religion || "N/A"}</p>
                      </div>
                      <div className="space-y-1">
                  ...
                  <CardContent className="space-y-6">
                    <div className="space-y-4">
                      <div className="space-y-2">
                        <Label className="text-base uppercase  text-foreground font-extrabold">
                        ...
                        <div className="grid grid-cols-2 gap-2 text-base leading-tight">
                          {student.motherName?.firstName ||
                            ...
                            <p className="font-extrabold text-foreground/50 italic">
                              Not provided
                            </p>
                          )}
                          <p
                            className={`flex items-center gap-2 ${student.motherName?.contactNumber
                              ? "text-foreground"
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="grid grid-cols-2 gap-2 text-base leading-tight">
                          ...
                          <p
                            className={`flex items-center gap-2 ${student.fatherName?.contactNumber
                              ? "text-foreground"
                              : "text-foreground/50 italic"
                              }`}>
                            <Phone className="h-3 w-3" />{" "}
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="grid grid-cols-2 gap-2 text-base leading-tight">
                          ...
                          <p
                            className={`flex items-center gap-2 ${student.guardianInfo?.contactNumber
                              ? "text-foreground"
                              : "text-foreground/50 italic"
                              }`}>
                            <Phone className="h-3 w-3" />{" "}
                    ...
                    <div className="space-y-1 text-base leading-tight">
                      ...
                      {student.emailAddress ? (
                        <p className="font-extrabold">{student.emailAddress}</p>
                      ) : (
                        <p className="font-extrabold text-foreground/50 italic">
                  ...
                  <Card className="col-span-1 md:col-span-2 border-primary/20 bg-primary/5">
                    ...
                    <CardContent>
                      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div>
                          <p className="text-base leading-tight font-extrabold">Reset Portal PIN</p>
            ...
            <TabsContent
              ...
              <motion.div
                    ...
                    <Card className="border-amber-200 bg-amber-50/30 overflow-hidden">
                      <CardHeader className="bg-amber-100/50 pb-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <CardTitle className="text-lg font-extrabold uppercase text-amber-900 leading-none">
                              Deficiency Resolution
                            </CardTitle>
                            <p className="text-base font-extrabold text-amber-700/70 mt-1 uppercase ">
                          ...
                          <div className="flex flex-wrap gap-3 pt-2">
                            {student.isMissingSf9 && (
                              <Button
                                variant="default"
                                size="sm"
                                className="bg-amber-600 hover:bg-amber-700 text-white font-extrabold h-9 gap-2"
                                onClick={async () => {
                                  if (
                                    window.confirm(
                            ...
                            {student.hasUnsettledPrivateAccount && (
                              <Button
                                variant="default"
                                size="sm"
                                className="bg-emerald-600 hover:bg-emerald-700 text-white font-extrabold h-9 gap-2"
                                onClick={async () => {
                                  if (
                                    window.confirm(
                ...
                <Card className="h-fit">
                  ...
                  <CardContent className="space-y-4 text-base leading-tight font-extrabold">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      {student.hasPsaBirthCertificate ||
                        ...
                        <div
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p
                                className={cn(
                                  "text-base font-extrabold mt-1 uppercase ",
                                  student.hasPsaBirthCertificate ||
                                    student.birthCertificateType === "PSA"
                                    ? "text-emerald-600"
                                    : "text-amber-700/70",
                          ...
                          {student.hasPsaBirthCertificate ||
                            ...
                            <div className="flex items-center gap-2 bg-primary/10 p-3 rounded-lg border border-primary/20 mt-2">
                              ...
                              <p className="text-base font-extrabold uppercase  text-primary">
                            ...
                            <div className="bg-muted/50 p-3 rounded-lg border border-amber-200">
                              ...
                              <p className="text-base font-extrabold text-amber-700 mt-1 leading-tight">
                          ...
                          <div
                            ...
                            <p
                              className={cn(
                                "text-base font-extrabold leading-relaxed italic",
                                student.hasPsaBirthCertificate ||
                                  student.birthCertificateType === "PSA"
                                  ? "text-emerald-800"
                                  : "text-amber-800",
                          ...
                          {!(
                            ...
                            student.birthCertificateType === "PSA"
                              ...
                              <Button
                                variant="outline"
                                size="sm"
                                className="w-full border-amber-300 text-amber-800 hover:bg-amber-100 font-extrabold uppercase text-base  h-8 mt-2"
                        ...
                        <div className="flex flex-col p-6 rounded-2xl bg-rose-50 border-2 border-rose-100 space-y-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <h3 className="font-extrabold text-rose-900 uppercase leading-none">
                                PSA Birth Certificate
                              </h3>
                              <p className="text-base font-extrabold mt-1 uppercase  text-rose-600">
                                Missing from Vault
                              </p>
                            </div>
                          </div>
                          ...
                          <Button
                            className="w-full h-12 bg-primary hover:bg-primary/90 text-primary-foreground font-extrabold uppercase  gap-2 shadow-lg shadow-primary/20"
                            onClick={() => setIsAuthModalOpen(true)}>
                            <ShieldCheck className="h-5 w-5" />
                      ...
                      <div className="flex flex-col p-6 rounded-2xl bg-slate-50 border-2 border-slate-100 space-y-4 opacity-60 grayscale cursor-not-allowed">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <h3 className="font-extrabold text-slate-900 uppercase leading-none">
                              SF10 (Permanent Record)
                            </h3>
                            <p className="text-base font-extrabold text-slate-500 mt-1 uppercase ">
                              Awaiting Graduation / Transfer
                            </p>
                          </div>
                        </div>
                        <p className="text-base font-extrabold text-slate-500 leading-relaxed italic">
                        ...
                        <div className="overflow-x-auto border rounded-lg">
                          <table className="w-full text-base leading-tight">
                            <thead className="bg-muted/40">
                              <tr>
                                <th className="text-left px-4 py-3 font-extrabold uppercase text-base  text-foreground">
                                  Date / Time
                                </th>
                                <th className="text-left px-4 py-3 font-extrabold uppercase text-base  text-foreground">
                                  Action
