...
export default function EnrollmentManagement() {
  ...
  const assignLearners = async () => {
    ...
    setProcessing(true);
    try {
      await api.post("/sectioning/assign", {
      ...
      sileo.error({
        ...
        description: "An error occurred while moving learners. Please try again.",
      });
    } finally {
      setProcessing(false);
    }
    ...
    <div className="flex flex-col h-[calc(100vh-120px)] overflow-hidden">
      ...
      <div className="flex items-center justify-between pb-6 flex-shrink-0">
        <div className="space-y-1">
          ...
          <p className="text-sm font-bold text-foreground">Review unassigned learners and place them into sections.</p>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-hidden">
        <div className="h-full flex gap-6 pb-6 overflow-hidden">
