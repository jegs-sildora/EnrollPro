          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div className="relative">
                ...
                />
                <kbd className="absolute right-3 top-1/2 -translate-y-1/2 hidden sm:inline-flex items-center gap-1 px-1.5 py-0.5 text-[10px]  text-gray-400 bg-gray-100 rounded border border-gray-200">
                      ...
                      paginatedStudents.map((student) => {
                        ...
                        return (
                          <TableRow key={student.id} className="transition-colors border-b border-slate-50 hover:bg-slate-50/50">
                            ...
                            <TableCell className=" text-slate-600 py-4">{student.sectionName || "-"}</TableCell>
                            <TableCell className="py-4">
                              <Badge
                                variant="outline"
