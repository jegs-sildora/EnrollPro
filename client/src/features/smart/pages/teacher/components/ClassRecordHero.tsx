        ...
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-8">
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              <h1 className="text-3xl font-bold text-slate-900 tracking-tight uppercase">{classAssignment.subject.name}</h1>
      ...
      {(classAssignment.isActive === false || !!classAssignment.archivedAt) && (
        <Card className="border-0 shadow-lg shadow-rose-100/50 rounded-[2rem] overflow-hidden bg-rose-50/60 border border-rose-100">
          <CardContent className="p-6 flex flex-col gap-2">
            <p className="text-[10px] font-bold uppercase tracking-[0.25em] text-rose-600">Archived from Atlas</p>
            ...
            {classAssignment.archivedReason && (
              <p className="text-[10px]  text-rose-500 uppercase tracking-widest">
