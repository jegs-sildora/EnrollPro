    ...
    <div className="overflow-hidden rounded-2xl border-2 border-red-200 bg-muted shadow-lg shadow-red-100/40 animate-fade-in">
      ...
      >
        ...
        <div className="flex-1 min-w-0 flex flex-wrap items-center gap-x-3 gap-y-1">
          <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-red-600 whitespace-nowrap">
            ⛔ Overdue — Grades Not Submitted
          </span>
          <span className="px-2 py-0.5 rounded-lg bg-red-100 text-red-700 text-[9px] font-bold uppercase tracking-widest whitespace-nowrap">
        ...
        <div className="flex items-center gap-3 flex-shrink-0">
          <div className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-red-600 text-white shadow-sm">
            ...
            <span className="text-[9px] font-bold uppercase tracking-widest">Contact Admin</span>
          </div>
            ...
            {!hideLink && (
              <Link to="/teacher/classes" className="flex-shrink-0">
                <Button
                  size="sm"
                  variant="outline"
                  className="h-8 px-4 rounded-xl border-red-200 text-red-600 hover:bg-red-600 hover:text-white font-bold text-[9px] tracking-widest uppercase transition-all"
                >
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            {!hideLink && (
              <Link to="/teacher/classes">
                <Button
                  size="sm"
                  className="h-10 px-5 rounded-xl bg-amber-500 hover:bg-amber-600 text-white font-bold text-[10px] tracking-widest uppercase border-0 shadow-lg shadow-amber-200 transition-all active:scale-95"
                >
    ...
    return (
      <div className="relative overflow-hidden rounded-3xl border border-orange-200 bg-gradient-to-r from-orange-50 to-amber-50 p-5 shadow-lg shadow-orange-100/60 animate-fade-in">
        ...
        <div className="relative flex flex-col sm:flex-row sm:items-center gap-4 pl-3">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-orange-600 mb-1">
          ...
          {!hideLink && (
            <div className="flex-shrink-0">
              <Link to="/teacher/classes">
                <Button
                  size="sm"
                  className="h-11 px-6 rounded-xl bg-orange-500 hover:bg-orange-600 text-white font-bold text-[10px] tracking-widest uppercase border-0 shadow-xl shadow-orange-200 transition-all active:scale-95 group"
                >
                  Submit Now
    ...
    return (
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-rose-600 to-red-600 p-5 shadow-2xl shadow-rose-300/50 animate-fade-in">
        ...
        <div className="relative flex flex-col sm:flex-row sm:items-center gap-5">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[10px] font-bold uppercase tracking-[0.25em] text-rose-200 mb-1">
          ...
          {!hideLink && (
            <div className="flex-shrink-0">
              <Link to="/teacher/classes">
                <Button
                  size="sm"
                  className="h-12 px-7 rounded-2xl bg-muted text-rose-600 hover:bg-rose-50 font-bold text-[10px] tracking-widest uppercase border-0 shadow-2xl shadow-rose-800/30 transition-all active:scale-95 group"
                >
