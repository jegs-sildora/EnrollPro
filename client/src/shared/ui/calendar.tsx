  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekday: cn(
          "flex-1 rounded-(--cell-radius) text-sm font-normal text-foreground select-none",
