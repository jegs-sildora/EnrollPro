  ...
  useEffect(() => {
    ...
    if (data) {
      setSettings({
        ...
        activeSchoolYearStatus: data.activeSchoolYearStatus,
        depedSchoolId: data.depedSchoolId,
        ...
        scpAdmissionOpenDate: data.scpAdmissionOpenDate,
        scpAdmissionCloseDate: data.scpAdmissionCloseDate,
        ...
        currentSystemDate: data.currentSystemDate,
        currentSystemDateReceivedAt: Date.now(),
        steEnabled: data.steEnabled,
        steCapacity: data.steCapacity,
        spaEnabled: data.spaEnabled,
        spaCapacity: data.spaCapacity,
        spsEnabled: data.spsEnabled,
        spsCapacity: data.spsCapacity,
        steRosterLocked: data.steRosterLocked,
        spaRosterLocked: data.spaRosterLocked,
        spsRosterLocked: data.spsRosterLocked,
