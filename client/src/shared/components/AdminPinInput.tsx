    ...
    <div className="flex items-center gap-2 sm:gap-3">
      {digits.map((digit, index) => (
        <Input
          ...
          className={cn(
            "h-14 w-12 sm:h-16 sm:w-14 rounded-2xl border-2 bg-muted/30 px-0 text-center text-3xl sm:text-4xl font-bold tabular-nums leading-none text-foreground shadow-sm transition-colors",
