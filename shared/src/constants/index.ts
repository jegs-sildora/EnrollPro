...
> = {
  ...
  DROPPED: "DROPPED",
  PENDING_SCP_SCREENING: "ASSESSMENT_IN_PROGRESS",
  QUALIFIED_SCP: "ASSESSMENT_IN_PROGRESS",
  REGISTERED_BEC: "QUALIFIED_FOR_ENROLLMENT",
  PENDING_READING: "ASSESSMENT_IN_PROGRESS",
  PENDING_INTAKE_CONFIRMATION: "QUALIFIED_FOR_ENROLLMENT",
};
...
> = {
  ...
  QUALIFIED_SCP: ["PENDING_READING", "REGISTERED_BEC", "WITHDRAWN"],
  REGISTERED_BEC: ["PENDING_READING", "WITHDRAWN"],
  PENDING_READING: ["PENDING_INTAKE_CONFIRMATION", "WITHDRAWN"],
  PENDING_INTAKE_CONFIRMATION: ["READY_FOR_SECTIONING", "WITHDRAWN"],
...
export const DEPED_TEACHER_SPECIALIZATION_GROUPS = [
  {
    ...
    options: [
      ...
      { value: "BSEd Mathematics", label: "BSEd Mathematics" },
      { value: "BSEd General Science", label: "BSEd General Science" },
      { value: "BSEd Social Studies", label: "BSEd Social Studies (Araling Panlipunan)" },
      { value: "BSEd Values Education", label: "BSEd Values Education (EsP)" },
      { value: "BSEd MAPEH", label: "BSEd MAPEH (Integrated)" },
      { value: "BPEd Physical Education", label: "BPEd Physical Education" },
      { value: "BTVTEd Home Economics", label: "BTVTEd Home Economics (HE)" },
      { value: "BTVTEd Industrial Arts", label: "BTVTEd Industrial Arts (IA)" },
      { value: "BTVTEd Agri-Fishery Arts", label: "BTVTEd Agri-Fishery Arts (AFA)" },
      { value: "BTVTEd Information and Communication Technology", label: "BTVTEd ICT" },
      { value: "BS Mathematics - CPE Units", label: "BS Mathematics (with CPE Units)" },
      { value: "BS Psychology - CPE Units", label: "BS Psychology (with CPE Units)" },
      { value: "AB Political Science - CPE Units", label: "AB Political Science (with CPE Units)" },
    ],
  },
  {
    group: "Science, Technology, and Engineering (STE)",
    options: [
      { value: "BSEd Physical Sciences", label: "BSEd Physical Sciences" },
      { value: "BSEd Biology", label: "BSEd Biology" },
      { value: "BSEd Chemistry", label: "BSEd Chemistry" },
      { value: "BS Physics - CPE Units", label: "BS Physics (with CPE Units)" },
      { value: "BS Environmental Science - CPE Units", label: "BS Environmental Science (with CPE Units)" },
      { value: "BSEd Mathematics - Statistics Focus", label: "BSEd Mathematics (Statistics Focus)" },
    ],
  },
  {
    group: "Special Program in the Arts (SPA)",
    options: [
      { value: "BCAEd Music Education", label: "BCAEd Music Education" },
      { value: "BCAEd Visual Arts", label: "BCAEd Visual Arts" },
      { value: "BCAEd Theater Arts", label: "BCAEd Theater Arts" },
      { value: "BCAEd Dance Education", label: "BCAEd Dance Education" },
      { value: "BCAEd Media Arts", label: "BCAEd Media Arts" },
      { value: "AB Literature - CPE Units", label: "AB Literature / Creative Writing (with CPE)" },
    ],
  },
  {
    group: "Special Program in Sports (SPS)",
    options: [
      { value: "BPEd Sports Coaching", label: "BPEd Sports Coaching" },
      { value: "BPEd Athletics Focus", label: "BPEd Athletics Focus" },
      { value: "BS Sports Science - CPE Units", label: "BS Sports Science (with CPE Units)" },
      { value: "Certified Specialist Coach", label: "Industry Certified Specialist Coach" },
    ],
  },
  {
    group: "Special Program in Journalism (SPJ)",
    options: [
      { value: "BSEd English - Campus Journalism", label: "BSEd English (Campus Journalism)" },
      { value: "BSEd Filipino - Campus Journalism", label: "BSEd Filipino (Campus Journalism)" },
      { value: "AB Journalism - CPE Units", label: "AB Journalism (with CPE Units)" },
      { value: "AB Mass Communication - CPE Units", label: "AB Mass Communication (with CPE Units)" },
    ],
  },
  {
    group: "Special Program in Foreign Language (SPFL)",
    options: [
      { value: "AB Linguistics - CPE Units", label: "AB Linguistics (with CPE Units)" },
      { value: "Specialization in Spanish (DELE Certified)", label: "Specialization in Spanish (DELE Certified)" },
      { value: "Specialization in Japanese (JLPT Certified)", label: "Specialization in Japanese (JLPT Certified)" },
      { value: "Specialization in French (DELF Certified)", label: "Specialization in French (DELF Certified)" },
      { value: "Specialization in Mandarin (HSK Certified)", label: "Specialization in Mandarin (HSK Certified)" },
      { value: "Specialization in Korean (TOPIK Certified)", label: "Specialization in Korean (TOPIK Certified)" },
    ],
  },
];
