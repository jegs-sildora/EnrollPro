...
const schedule2026 = deriveSchoolYearScheduleFromOpeningDate(new Date('2026-06-01'));
...
const decSchedule = deriveSchoolYearScheduleFromOpeningDate(new Date('2026-12-01'));
...
const testSchedule = deriveSchoolYearScheduleFromOpeningDate(new Date('2026-06-01'));
