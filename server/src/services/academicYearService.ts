...
export function deriveAcademicYearScheduleFromOpeningDate(classOpeningDate: Date, classEndTemplate?: Date) {
...
export function deriveNextAcademicYear(today: Date) {
  ...
  const nextStartYear = currentAcademicStartYear + 1;

  return deriveAcademicYearScheduleFromOpeningDate(
