...
async function main() {
  console.log("🌱 Seeding EOSY mock grades for 2028-2029...");
  ...
  await prisma.$transaction(async (tx) => {
    ...
    console.log(`✅ Successfully seeded mock EOSY data for ${totalSeeded} learners in 2028-2029.`);
  });
}

main()
  .catch((e) => {
    console.error("❌ Failed to seed EOSY mock data for 2028-2029. Transaction rolled back.", e);
    process.exit(1);
  })
  .finally(async () => {
