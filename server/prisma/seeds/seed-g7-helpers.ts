...
const FILIPINO_MALE_FIRST_NAMES = [
  ...
  "ALEXANDER", "JONATHAN", "KEVIN", "LORENZO", "MATTHEW", "RICHARD",
  "IAN", "CARL", "JAYSON", "RENZ", "RONALD", "AARON", "JUSTIN", "LESTER",
  "DARREN", "KENNETH", "EDGAR", "RAYMOND", "JULIUS", "ROMEO", "ARTHUR",
  "RODRIGO", "ALVIN", "RYAN", "EUGENE", "DEXTER", "GARY", "MELVIN",
  "ROBERTO", "EDUARDO", "RAMON", "FELIX", "NEIL", "ROLANDO", "MARLON"
];
...
const FILIPINO_FEMALE_FIRST_NAMES = [
  ...
  "SAMANTHA", "NICOLE", "CHRISTINE", "MICHELLE", "JESSICA", "SARAH",
  "KIMBERLY", "JOYCE", "RACHEL", "DIANE", "MELISSA", "KAREN", "JOANNA",
  "VALERIE", "SHIELA", "VANESSA", "KRISTINE", "JASMINE", "ERIKA",
  "MAUREEN", "ROSALIE", "MYLENE", "GLADYS", "ROWENA", "MARICEL", "LEAH",
  "JENNY", "CHERRY", "HAZEL", "MARILOU", "ROSEMARIE", "ANALYN", "SHARON"
];
...
const FILIPINO_SURNAMES = [
  ...
  "VALDEZ", "AGUILAR", "DOMINGO", "GONZALES", "PEREZ", "DEL ROSARIO",
  "TOLENTINO", "ALVAREZ", "GOMEZ", "TORRES", "MARQUEZ", "JIMENEZ",
  "OCAMPO", "MIRANDA", "PASCUAL", "RODRIGUEZ", "CORTEZ", "SANTIAGO",
  "VILLAR", "ROXAS", "NATIVIDAD", "PINEDA", "TAYAG", "SORIANO",
  "CUSTODIO", "BALUYOT", "HERRERA", "ENRIQUEZ", "MAGSINO", "LUCERO"
];
